...
Something to consider: change all area names from AreaX_Y to AreaXX_YYY

```{r trainDecisionTree, message=FALSE, warning=FALSE}
library(rpart)
...
leafData_subset$n <- leafData[c(21:37),"Area10_1_nBusinessDaysTilPickup"]
#leafData_subset
