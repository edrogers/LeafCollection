...
generateModelData <- function(leafDataWest,targetArea) {
  ...
  nColsFromCurrent <- ifelse(nColsFromCurrent < 30 & leafDataWestStatuses[,targetArea]=="Recently Done", 
                             ...
                             nColsFromCurrent)
#   nColsFromCurrent <- ifelse(leafDataWestStatuses[,targetArea]=="Recently Done",apply(cbind(ncol(leafDataWestStatuses)-match(leftmostDoneOrNextColName,colnames(leafDataWestStatuses)),nColsFromCurrent),1,max),nColsFromCurrent)
#   nColsFromCurrent <- ifelse(leafDataWestStatuses[,targetArea]=="Recently Done",ncol(leafDataWestStatuses)-match(leftmostDoneOrNextColName,colnames(leafDataWestStatuses)),nColsFromCurrent)
#   nColsFromCurrent <- ifelse(leafDataWestStatuses[,targetArea]=="Recently Done",apply(cbind(ncol(leafDataWestStatuses)-match(leftmostDoneOrNextColName,colnames(leafDataWestStatuses)),nColsFromCurrent),1,max),nColsFromCurrent)
...
selectedFit <- fit3
dataForPlots <- data.frame(modelData,fitted=selectedFit$finalModel$fitted.values,residuals=selectedFit$finalModel$residuals)
# }

saveRDS(selectedFit, "model.rds", ascii=TRUE)
```
