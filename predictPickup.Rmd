...
for(myArea in levels(modelData$Area)) {
  subset <- modelData[modelData$Area==myArea & (modelData$status=="Next" | modelData$status=="Done" | modelData$status=="Current" | modelData$status=="Recently Done"),]
...
saveRDS(models, "models.rds", ascii=TRUE)
```
